...
public class PickingActivity extends Activity {
	...
	private ConsultaPedidos consultaPedidos;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		AuxiliarFunctions.hideKeyboard(PickingActivity.this);
		...
		this.consultaPedidos = new ConsultaPedidos(this, articleInfoData, articleInfo);
		this.consultaPedidos.execute(String.valueOf(this.mode), String.valueOf(this.albaran),
		...
		this.articleInfo.setOnItemLongClickListener(new OnItemLongClickListener() {
			...
			public boolean onItemLongClick(AdapterView<?> parent, View view, int position, long id) {
				...
				AlertDialog.Builder alert = new AlertDialog.Builder(PickingActivity.this);
				posicion = position;
					...
					public void onClick(DialogInterface dialog, int which) {
						...
						case 0:
							...
							new ConexionMarcarArticuloEnviado(PickingActivity.this, articleInfo, articleInfoData, mode,
									selItem.getPosicion(),selItem.getRegistro(), albaran).execute(codigoPedido.getText().toString(),
							...
							new AlertDialog.Builder(PickingActivity.this).setTitle("Numero etiquetas a imprimir")
							    ...
							    .setPositiveButton(android.R.string.ok, new DialogInterface.OnClickListener() {
							        ...
							        public void onClick(DialogInterface dialogInterface, int i) {
							        	...
							        	new ConsultaImprimirPedido().execute(String.valueOf(mode), String.valueOf(albaran),

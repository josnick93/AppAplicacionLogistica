...
public class AdaptadorAlbaranesSalida extends ArrayAdapter<MapeoAlbaran> {
	private final Context context;
	private final ArrayList<MapeoAlbaran> modelsArrayList;

	public AdaptadorAlbaranesSalida(Context context, ArrayList<MapeoAlbaran> modelsArrayList) {

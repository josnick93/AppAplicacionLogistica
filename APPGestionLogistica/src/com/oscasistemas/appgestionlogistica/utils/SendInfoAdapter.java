...
public class SendInfoAdapter extends ArrayAdapter<MapeoPedido> {
	private final Context context;
	private final ArrayList<MapeoPedido> modelsArrayList;

	public SendInfoAdapter(Context context, ArrayList<MapeoPedido> modelsArrayList) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if(modelsArrayList.get(position).getFechaEntrega()!=null)sendDate.setText(postFormater.format(modelsArrayList.get(position).getFechaEntrega()));
